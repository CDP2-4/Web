    ...
    <div id="container">
		...
		<?php
			...
			<div class="member_list_area">
				<form action = "warehouse_modify_ok.php?no=<?php echo $no;?>" method="post"> 
            ...
            <div class="btn_area01">
				...
				<input type="button" value="QR생성" class="blue_btn" style = "margin-top: 20px;" onClick="location.href='warehouse_qr.php?no=<?php echo $no;?>'" />
			</div>
			</form>
			</div>
        </div>
